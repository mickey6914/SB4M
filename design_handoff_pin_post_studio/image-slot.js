  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '  <button data-act="clear" title="Clear image">Clear</button>' +
      ...
      root.addEventListener('click', (e) => {
        ...
        if (act === 'clear') { this.clearImage(); return; }
        if (act === 'edit') {
    ...
    // Public: empty this slot back to its placeholder (or its author src).
    clearImage() {
      this._exitReframe(false);
      this._gen++;
      this._swapGen = 0;
